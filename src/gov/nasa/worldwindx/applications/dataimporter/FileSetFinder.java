...
//            fileSet.setValue(FileSet.SECTOR_LIST, fileSectors.toArray());
    ...
    protected static class FileSetKey
    {
        ...
        public boolean equals(Object o)
        {
            ...
            if ((dataType != null ? !dataType.equals(that.dataType) : that.dataType != null) || (parentDirectory != null ? !parentDirectory.equals(that.parentDirectory) : that.parentDirectory != null) || (suffix != null ? !suffix.equals(that.suffix) : that.suffix != null))
                return false;
