...
//            return false;
        if ((Double.compare(that.altitude, altitude) != 0) || (corners != null ? !corners.equals(that.corners) : that.corners != null) || (name != null ? !name.equals(that.name) : that.name != null)
				|| (sector != null ? !sector.equals(that.sector) : that.sector != null))
            return false;
