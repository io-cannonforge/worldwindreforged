...
public class SegmentPlaneEditor extends AbstractLayer
{
    ...
    {
        if (!this.isArmed() || this.getSegmentPlane() == null || this.getSegmentPlaneRenderer() == null)
            return;
    ...
    public void moveControlPoint(WorldWindow wwd, PickedObject pickedObject, Point mousePoint, Point previousMousePoint)
    {
        ...
        if ((this.getSegmentPlane() == null) || !(pickedObject.getObject() instanceof SegmentPlane.ControlPoint))
        {
            return;
        }
