 ...
 * Connects to the USGS 3DEP (3D Elevation Program) WCS service and populates an elevation model
 * from the returned coverage data.
 *
 * <p>The default server is the USGS National Map 3DEP WCS service. Additional servers can be
 * added at runtime via the "+" tab.</p>
 *
 * @author tag
 * @version $Id: WCSElevations.java 2136 2014-07-10 01:01:13Z pabercrombie $
 * @see gov.nasa.worldwindx.examples.util.WCSCoveragePanel
 */
