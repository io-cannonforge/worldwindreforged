...
/**
 * Tests the {@link gov.nasa.worldwind.terrain.HighResolutionTerrain} class by sampling precise
 * terrain elevations at a grid of geographic positions and reporting timing statistics.
 *
 * <p>Elevation data is sourced through the GDAL 3.12 backend. This example is a useful
 * performance benchmark for terrain sampling throughput after Phase 4 GPU tessellation changes.</p>
 *
 * @author tag
