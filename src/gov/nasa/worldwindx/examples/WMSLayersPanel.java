...
public class WMSLayersPanel extends JPanel
{
    ...
    protected final TreeSet<LayerInfo> layerInfos = new TreeSet<>(new Comparator<LayerInfo>()
    {
        @Override
    ...
    protected void makeLayerInfosPanel(Collection<LayerInfo> layerInfos)
    {
        ...
        westPanel.setBorder(WWStyle.sectionBorder("Layers"));
    ...
    protected void updateComponent(Object component, boolean enable)
    {
        ...
        else if (component instanceof ElevationModel model)
        {
