...
public class MGRSAttributesPanel extends JPanel
{
    ...
    // Modified by seaglassfoundry.com - added generic type parameters
    private JComboBox<String> maxResolutionComboBox;
    ...
    private void updateLayer()
    {
        ...
        try
        {
            if (this.layer != null)
            {
                ...
                for (var entry : this.graticuleAttribPanelMap.entrySet())
                {
    ...
    private void makeComponents()
    {
        ...
        ListCellRenderer<? super String> originalRenderer = this.itemList.getCellRenderer();
    ...
    private static class GraticuleTypeListRenderer implements ListCellRenderer<String>
    {
        private ListCellRenderer<? super String> delegate;
        private Icon icon;

        public GraticuleTypeListRenderer(ListCellRenderer<? super String> delegate, Icon icon)
        {
