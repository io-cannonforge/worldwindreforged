...
public class Shapes {
    ...
    protected static class AppFrame extends JFrame {
        ...
        private JPanel makePathAttributesPanel() {
            ...
            final JComboBox<String> cb = new JComboBox<>(new String[]{"Great Circle", "Linear", "Rhumb Line"});
            ...
            final JComboBox<String> cb1 = new JComboBox<>(new String[]{"None", "Solid", "Dash"});
            ...
            JComboBox<String> cb2 = new JComboBox<>(new String[]{"Red", "Green", "Blue", "Yellow"});
            cb2.setSelectedItem(currentPathColor);
            cb2.addActionListener((ActionEvent actionEvent) -> {
                currentPathColor = (String) ((JComboBox<String>) actionEvent.getSource()).getSelectedItem();
                update();
            });
            valuePanel.add(cb2);
        ...
        private JPanel makeInteriorAttributesPanel() {
            ...
            namePanel.add(new JLabel("Style"));
            final JComboBox<String> cb1 = new JComboBox<>(new String[]{"None", "Solid"});
            cb1.addActionListener((ActionEvent actionEvent) -> {
            ...
            namePanel.add(new JLabel("Color"));
            final JComboBox<String> cb2 = new JComboBox<>(new String[]{"Red", "Green", "Blue", "Yellow"});
            cb2.setSelectedItem(currentInteriorColor);
            cb2.addActionListener((ActionEvent actionEvent) -> {
                currentInteriorColor = (String) ((JComboBox<String>) actionEvent.getSource()).getSelectedItem();
                update();
            });
            valuePanel.add(cb2);

            namePanel.add(new JLabel("Border"));
            final JComboBox<String> cb5 = new JComboBox<>(new String[]{"None", "Solid"});
            ...
            JComboBox<String> cb4 = new JComboBox<>(new String[]{"Red", "Green", "Blue", "Yellow"});
            cb4.setSelectedItem(currentBorderColor);
            cb4.addActionListener((ActionEvent actionEvent) -> {
                currentBorderColor = (String) ((JComboBox<String>) actionEvent.getSource()).getSelectedItem();
                update();
            });
            valuePanel.add(cb4);
