    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            if (this.controlPanel != null)
            {
                ...
                JScrollPane controlScroll = new JScrollPane(btnPanel);
                controlScroll.setBorder(null);
                tabs.addTab("Export", controlScroll);
        ...
        public void doSaveImage()
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (o instanceof TiledImageLayer layer)
                {
        ...
        private int[] adjustSize(Sector sector, int desiredSize)
        {
            ...
            if (null != sector && desiredSize > 0)
            {
                ...
                int minSize = (int) ((min == 0d) ? desiredSize : (desiredSize * min / max));
