...
/**
 * Shows how to apply EGM2008 geoid-undulation offsets to WorldWind elevation queries.
 *
 * <p>The EGM2008 data file ({@code egm2008_25.dat}) is not included in the SDK due to its size (~300 MB).
 * Obtain the file from the NGA EGM2008 page:
 * <a href="https://earth-info.nga.mil/index.php?dir=wgs84&action=wgs84">
 * https://earth-info.nga.mil/index.php?dir=wgs84&action=wgs84</a>
 * and place it in the WorldWind {@code src/config/} folder before running this example.</p>
 *
 * <p>Elevation data is provided by the GDAL 3.12 backend. Geoid offsets use the
 * {@link gov.nasa.worldwind.util.EGM2008} utility class.</p>
 */
