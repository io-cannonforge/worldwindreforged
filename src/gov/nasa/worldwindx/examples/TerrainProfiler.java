 ...
 * features.
 *
 * <p>Elevation data is sourced via the GDAL 3.12 backend. Compatible with Phase 4 GPU tessellation terrain.</p>
 *
 * @author tag
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        public AppFrame() {
            ...
            try {
                ...
                JPanel profileControls = makeControlPanel();
                ...
                if (this.controlPanel != null)
                {
                    ...
                    JScrollPane controlScroll = new JScrollPane(profileControls);
        ...
        private JPanel makeControlPanel() {
            ...
            final JComboBox<String> cbDimension = new JComboBox<>(new String[]{"Small", "Medium", "Large"});
            ...
            JSlider s = new JSlider(SwingConstants.HORIZONTAL, 0, 30,
            ...
            final JComboBox<String> cbFollow = new JComboBox<>(new String[]{"View", "Cursor", "Eye", "None", "Object"});
            ...
            controlPanel.setBorder(WWStyle.sectionBorder("Terrain profile"));
