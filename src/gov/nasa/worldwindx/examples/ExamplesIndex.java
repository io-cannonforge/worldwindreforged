...
public class ExamplesIndex extends JFrame {
    ...
    static {
        ...
        CATEGORIES.put("Surface Shapes", new ExampleEntry[]{
            ...
            new ExampleEntry("Small Surface Shapes",            BASE + "SmallSurfaceShapesDemo",       "Sub-metre precision stress test: a collection of ~10 m surface shapes (including a 32-sided 10 m-radius polygon circle) with the camera framed directly overhead. Validates the RTE reference-point vertex path.", "New"),
