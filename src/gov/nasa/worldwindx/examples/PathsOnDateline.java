 ...
 * WorldWind correctly tessellates and renders paths that span the date line without visual artefacts.
 *
 * <p>Dashed path outlines use the Phase 3 {@code DashLineShader} GPU path.</p>
 *
 * @author tag
