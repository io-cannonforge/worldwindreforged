 ...
 *
 * <p>The Phase 3 shader rendering path includes a picking fallback mode; surface shapes and paths are pickable
 * regardless of whether GPU shaders are active.</p>
 *
 * @author tag
