...
/**
 * Example of {@link gov.nasa.worldwind.render.Wedge} usage. Shows examples of wedges with various orientations,
 * materials, and textures applied.
 *
 * <p>Note: rigid shapes use GL2 fixed-function rendering. No Phase 3 shader path is active for this shape type.</p>
 *
 * @author ccrick
...
public class Wedges extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            JPanel detailControls = makeDetailHintControlPanel();
            ...
            if (this.controlPanel != null)
            {
                ...
                JScrollPane controlScroll = new JScrollPane(detailControls);
        ...
        protected JPanel makeDetailHintControlPanel()
        {
            ...
            controlPanel.setBorder(WWStyle.sectionBorder("Detail Hint"));
