...
public class AnnotationControls extends ApplicationTemplate
{
    ...
    public static ContentAnnotation createContentAnnotation(AppFrame appFrame, Position position, AVList params)
    {
        ...
        {
            return createImageAnnotation(appFrame, position, title, (Iterable<?>) source); // Modified by seaglassfoundry.com - added generic type parameter
        }
    ...
    // Modified by seaglassfoundry.com - added generic type parameter
    ...
    public static Clip openAudioStream(InputStream stream) throws Exception
    {
        ...
        // Modified by seaglassfoundry.com - fixed resource leak: close original ais before reassignment
        ...
        try
        {
                ...
                (format.getEncoding() == AudioFormat.Encoding.ALAW))
            {
                AudioFormat tmp = new AudioFormat(
                    ...
                    format.getFrameRate(),
                    true);
                AudioInputStream convertedAis = AudioSystem.getAudioInputStream(tmp, ais);
                ais.close();
                ais = convertedAis;
                format = tmp;
            }
    ...
    public static String createTitle(Iterable<?> sources) // Modified by seaglassfoundry.com - added generic type parameter
    {
        if (sources == null)
        {
            String message = Logging.getMessage("nullValue.IterableIsNull");
        ...
        java.util.Iterator<?> iter = sources.iterator(); // Modified by seaglassfoundry.com - added generic type parameter
        while (iter.hasNext())
        {
            Object o = iter.next();
