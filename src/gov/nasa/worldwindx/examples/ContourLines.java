...
public class ContourLines extends ApplicationTemplate {
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        public AppFrame() {
            ...
            JPanel contourControlPanel = this.makeContourLineControlPanel();
            ...
            if (this.controlPanel != null)
            {
                ...
                JScrollPane controlScroll = new JScrollPane(contourControlPanel);
        ...
        protected JPanel makeContourLineControlPanel() {
            ...
            controlPanel.setBorder(WWStyle.sectionBorder("Contour Line Elevation"));
