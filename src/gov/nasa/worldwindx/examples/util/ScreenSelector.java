...
public class ScreenSelector extends WWObjectImpl implements MouseListener, MouseMotionListener, SelectListener
{
    ...
    {
        if ((mouseEvent == null) || (InputEvent.BUTTON1_DOWN_MASK != mouseEvent.getModifiersEx())) // Respond to button 1 down w/o modifiers.
            return;
    ...
    {
        if ((mouseEvent == null) || !this.armed) // Respond to mouse released events when armed.
            return;
    ...
    {
        if ((mouseEvent == null) || !this.armed) // Respond to mouse dragged events when armed.
            return;
