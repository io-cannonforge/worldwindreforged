...
//                                showPositionsAndRays(positions, obstructionFlags);
        ...
        int[] intersectTerrain(List<Position> positions)
        {
            ...
            for (int i = 1; i < positions.size(); i++)
            {
                ...
                if (this.isBelowMinimumElevation(position, originPoint) || (i > gridSize && obstructionFlags[i - 1 - gridSize] == RadarVolume.EXTERNAL_OBSTRUCTION))
                {
                ...
                //
                // Modified by seaglassfoundry.com - removed dead code: CONE_VOLUME is true so !CONE_VOLUME block never executes
