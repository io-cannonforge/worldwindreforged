...
public class PlaceNameService
{
    ...
    public boolean equals(Object o)
    {
        ...
        if ((this.service != null ? !this.service.equals(other.service) : other.service != null) || (this.dataset != null ? !this.dataset.equals(other.dataset) : other.dataset != null) || (this.fileCachePath != null ? !this.fileCachePath.equals(other.fileCachePath) : other.fileCachePath != null)
				|| (this.maskingSector != null ? !this.maskingSector.equals(other.maskingSector) : other.maskingSector != null))
            return false;
