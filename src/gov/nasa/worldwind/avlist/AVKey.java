...
public interface AVKey // TODO: Eliminate unused constants, if any
{
    ...
    final String URL_MAX_RETRIES = "gov.nasa.worldwind.avkey.URLMaxRetries";
    final String URL_READ_TIMEOUT = "gov.nasa.worldwind.avkey.URLReadTimeout";
    final String URL_RETRY_BASE_DELAY = "gov.nasa.worldwind.avkey.URLRetryBaseDelay";
    final String WMTS_TILE_MATRIX_SET = "gov.nasa.worldwind.avkey.WMTSTileMatrixSet";
    final String WMTS_TILE_MATRIX_OFFSET = "gov.nasa.worldwind.avkey.WMTSTileMatrixOffset";
    final String WMTS_BINDING = "gov.nasa.worldwind.avkey.WMTSBinding";
    ...
    final String WMS_TIME_STRING = "gov.nasa.worldwind.avkey.WMSTimeString";
