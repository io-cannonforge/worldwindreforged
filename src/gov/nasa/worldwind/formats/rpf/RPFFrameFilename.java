...
public class RPFFrameFilename
{
	...
	public final boolean equals(Object o)
    {
        ...
        if ((Character.toUpperCase(this.zoneCode) != Character.toUpperCase(that.zoneCode)) || (this.frameNumber != that.frameNumber) || (this.dataSeriesCode != null ? !this.dataSeriesCode.equalsIgnoreCase(that.dataSeriesCode) : that.dataSeriesCode != null) || (Character.toUpperCase(this.producerId) != Character.toUpperCase(that.producerId)))
            return false;
    ...
    public static boolean isFilename(String str)
    {
        ...
        if (!Base34Converter.isBase34(buffer, 0, 7) || !RPFProducer.isProducerId(buffer[7]) || ('.' != buffer[8]))
            return false;
