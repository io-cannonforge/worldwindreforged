...
public class WorldFile
{
    ...
    {
        if ((values == null) || (!values.hasKey("NROWS") && !values.hasKey("NCOLS")))
            return null;
    ...
    {
        if ((values == null) || !values.hasKey("BYTEORDER"))
            return null;
    ...
    public static Object parsePixelFormat(AVList values)
    {
        ...
        if (values.hasKey("NBANDS") && values.hasKey("NBITS"))
        {
            ...
            if ((nBands == 1 && nBits == 8) || (nBands == 3 && nBits == 8))
                return AVKey.IMAGE;
        }
    ...
    {
        if ((values == null) || !values.hasKey("NODATA"))
            return null;
