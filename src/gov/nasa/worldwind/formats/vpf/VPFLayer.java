...
public class VPFLayer extends AbstractLayer
{
    ...
    // Threaded requests
    protected Queue<Runnable> requestQ = new PriorityBlockingQueue<>(4);
    protected Queue<Disposable> disposalQ = new ConcurrentLinkedQueue<>();
    ...
    protected static class RequestTask implements Runnable, Comparable<RequestTask>
    {
		...
		public boolean equals(Object o)
        {
            ...
            if ((coverageRenderable != null ? !coverageRenderable.equals(that.coverageRenderable)
                : that.coverageRenderable != null) || (tile != null ? !tile.equals(that.tile) : that.tile != null))
                return false;
