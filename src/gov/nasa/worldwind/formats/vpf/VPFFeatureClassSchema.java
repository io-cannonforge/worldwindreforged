...
public class VPFFeatureClassSchema
{
	...
	public boolean equals(Object o)
    {
        ...
        if ((this.className != null ? !this.className.equals(that.className) : that.className != null) || (this.featureTableName != null ? !this.featureTableName.equals(that.featureTableName)
            : that.featureTableName != null) || (this.type != null ? !this.type.equals(that.type) : that.type != null))
            return false;
