...
public class VPFFeatureClass extends AVListImpl
{
	...
	public boolean equals(Object o)
    {
        ...
        if ((this.coverage != null ? !this.coverage.getFilePath().equals(that.coverage.getFilePath())
            : that.coverage != null) || (this.schema != null ? !this.schema.equals(that.schema) : that.schema != null) || !Arrays.equals(this.relations, that.relations) || (this.joinTableName != null ? !this.joinTableName.equals(that.joinTableName) : that.joinTableName != null))
            return false;
