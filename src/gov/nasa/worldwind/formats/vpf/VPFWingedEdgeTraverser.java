...
public class VPFWingedEdgeTraverser
{
    ...
    protected int nextEdgeId(int faceId, int prevEdgeId, int curEdgeId, VPFPrimitiveData.PrimitiveInfo[] edgeInfoArray)
    {
        ...
        return switch (o)
        {
            ...
            case LEFT_AND_RIGHT -> (prevEdgeId > 0) ? this.auxiliaryNextEdgeId(prevEdgeId, curEdgeId, edgeInfoArray) : -1;
            default -> -1;
        };
    }
        ...
        VPFPrimitiveData.PrimitiveInfo[] edgeInfo)
    {
        ...
        return switch (o)
        {
            case LEFT -> true;
            case RIGHT -> false;
            case LEFT_AND_RIGHT -> (prevEdgeId > 0) && this.auxiliaryMustReverseCoordinates(prevEdgeId, curEdgeId, edgeInfo);
            default -> false;
        };
    }
