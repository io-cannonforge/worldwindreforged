...
public class VPFSymbolAttributes extends BasicShapeAttributes
{
    public static class LabelAttributes
    {
        ...
        public boolean equals(Object o)
        {
            ...
            if ((this.abbreviationTableId != that.abbreviationTableId) || (Double.compare(this.offset, that.offset) != 0) || (this.append != null ? !this.append.equals(that.append) : that.append != null) || (this.attributeName != null ? !this.attributeName.equals(that.attributeName)
	...
	public void copy(ShapeAttributes attributes)
    {
        ...
        if (attributes instanceof VPFSymbolAttributes vpfAttrs)
        {
