...
public class VPFRelation
{
	...
	public boolean equals(Object o)
    {
        ...
        if ((this.table1 != null ? !this.table1.equals(that.table1) : that.table1 != null) || (this.table1Key != null ? !this.table1Key.equals(that.table1Key) : that.table1Key != null) || (this.table2 != null ? !this.table2.equals(that.table2) : that.table2 != null)
				|| (this.table2Key != null ? !this.table2Key.equals(that.table2Key) : that.table2Key != null))
            return false;
