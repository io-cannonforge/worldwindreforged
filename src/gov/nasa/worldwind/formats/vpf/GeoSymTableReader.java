...
public class GeoSymTableReader
{
    ...
    public boolean canRead(String filePath)
    {
        ...
        Object streamOrException = WWIO.getFileOrResourceAsStream(filePath, this.getClass());
    ...
    {
        try (InputStream inputStream = WWIO.openFileOrResourceStream(filePath, this.getClass()))
        {
            return this.readTable(filePath, inputStream);
        }
    }
