    ...
    Disposable
{
    ...
    {
        if ((this.wwd == null) || (this.wwd.getView() == null) || (awtMouseEvent == null))
        {
            return;
        }
    ...
    {
        if ((this.wwd == null) || (awtMouseEvent == null))
        {
            return;
        }
    ...
    public void mouseDragged(MouseEvent awtMouseEvent)
    {
        ...
        if ((InputEvent.BUTTON1_DOWN_MASK & mouseEvent.getModifiersEx()) != 0)
        {
    ...
    {
        if ((this.wwd == null) || (awtMouseWheelEvent == null))
        {
            return;
        }
    ...
    {
        if ((this.wwd == null) || (this.wwd.getView() == null) || (event == null))
        {
            return;
        }
