...
{
    public class DeviceModifierMap extends HashMap<Object, ArrayList<ActionAttributes>>
    {
    ...
    public static class ActionAttributes
    {
        ...
        private java.util.List<KeyAction> keyActions;
        private java.util.List<MouseAction> mouseActions;
        ...
        public java.util.List<KeyAction> getKeyActions()
        {
        ...
        public void setKeyActions(java.util.List<KeyAction> keyActions)
        {
            this.keyActions = keyActions;
        }

        public java.util.List<MouseAction> getMouseActions()
        {
        ...
        public void setMouseActions(java.util.List<MouseAction> mouseActions)
        {
    ...
    public void addModifierActionList(Object device, Integer modifier)
    {
        ...
        ArrayList<ActionAttributes> modifierList = deviceActionMap.get(modifier);
    ...
    public List<ActionAttributes> getModifierActionList(Object device, Integer modifier)
    {
        Map<Object, ArrayList<ActionAttributes>> deviceModActionMap = this.getModifierActionMap(device);
    ...
    protected void setDeviceModifierActionMaps()
    {
        ...
        this.addAction(DEVICE_MOUSE, InputEvent.ALT_DOWN_MASK, VIEW_MOVE_TO_SLOW,
        ...
        this.addAction(DEVICE_MOUSE, InputEvent.SHIFT_DOWN_MASK, VIEW_ROTATE_SHIFT,
        ...
        this.addAction(DEVICE_MOUSE, ActionAttributes.NO_MODIFIER, VIEW_VERTICAL_TRANSLATE,
            new ActionAttributes(verticalTransMouseEvents, ActionAttributes.ActionTrigger.ON_DRAG,
                ...
                DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_VALUE));
        this.addAction(DEVICE_MOUSE, InputEvent.CTRL_DOWN_MASK, VIEW_VERTICAL_TRANSLATE_CTRL,
            new ActionAttributes(verticalTransMouseEventsCtrl, ActionAttributes.ActionTrigger.ON_DRAG,
                DEFAULT_MOUSE_VERTICAL_TRANSLATE_VALUE, DEFAULT_MOUSE_VERTICAL_TRANSLATE_VALUE,
                DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_VALUE));
        this.addAction(DEVICE_MOUSE, InputEvent.META_DOWN_MASK, VIEW_VERTICAL_TRANSLATE_CTRL,
            new ActionAttributes(verticalTransMouseEventsCtrl, ActionAttributes.ActionTrigger.ON_DRAG,
                DEFAULT_MOUSE_VERTICAL_TRANSLATE_VALUE, DEFAULT_MOUSE_VERTICAL_TRANSLATE_VALUE,
                DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_VALUE));

        // Keyboard Rotation Actions
        this.addAction(DEVICE_KEYBOARD, InputEvent.SHIFT_DOWN_MASK, VIEW_ROTATE_KEYS_SHIFT,
        ...
        this.addAction(DEVICE_KEYBOARD, InputEvent.SHIFT_DOWN_MASK | InputEvent.ALT_DOWN_MASK, VIEW_ROTATE_KEYS_SHIFT_SLOW,
            this.makeSlowActionAttributes(this.getActionAttributes(
                DEVICE_KEYBOARD, VIEW_ROTATE_KEYS_SHIFT), DEFAULT_SLOW_VALUE));
        this.addAction(DEVICE_KEYBOARD, InputEvent.ALT_DOWN_MASK, VIEW_ROTATE_SLOW,
            this.makeSlowActionAttributes(this.getActionAttributes(
                DEVICE_KEYBOARD, VIEW_ROTATE_KEYS), DEFAULT_SLOW_VALUE));

        // Keyboard Roll Actions
        this.addAction(DEVICE_KEYBOARD, InputEvent.CTRL_DOWN_MASK, VIEW_ROLL_KEYS,
        ...
        this.addAction(DEVICE_KEYBOARD, ActionAttributes.NO_MODIFIER, VIEW_HORIZONTAL_TRANS_KEYS,
            new ActionAttributes(horizontalTransKeyEvents, ActionAttributes.ActionTrigger.ON_KEY_DOWN, 0,
                ...
                DEFAULT_HORIZONTAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_HORIZONTAL_TRANSLATE_SMOOTHING_VALUE));
        this.addAction(DEVICE_KEYBOARD, InputEvent.ALT_DOWN_MASK, VIEW_HORIZONTAL_TRANSLATE_SLOW,
            this.makeSlowActionAttributes(this.getActionAttributes(
        ...
        this.addAction(DEVICE_KEYBOARD, ActionAttributes.NO_MODIFIER, VIEW_VERTICAL_TRANS_KEYS,
            new ActionAttributes(verticalTransKeyEvents, ActionAttributes.ActionTrigger.ON_KEY_DOWN, 0,
                ...
                DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_VALUE));
        this.addAction(DEVICE_KEYBOARD, InputEvent.ALT_DOWN_MASK, VIEW_VERTICAL_TRANS_KEYS_SLOW,
            this.makeSlowActionAttributes(this.getActionAttributes(
                DEVICE_KEYBOARD, VIEW_VERTICAL_TRANS_KEYS), DEFAULT_SLOW_VALUE));

        this.addAction(DEVICE_KEYBOARD, InputEvent.CTRL_DOWN_MASK, VIEW_VERTICAL_TRANS_KEYS_CTRL,
            new ActionAttributes(verticalTransKeyEventsCtrl, ActionAttributes.ActionTrigger.ON_KEY_DOWN,
                (InputEvent.CTRL_DOWN_MASK),
                DEFAULT_KEY_VERTICAL_TRANSLATE_VALUE, DEFAULT_KEY_VERTICAL_TRANSLATE_VALUE,
                DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_ENABLED, DEFAULT_VERTICAL_TRANSLATE_SMOOTHING_VALUE));
        this.addAction(DEVICE_KEYBOARD, InputEvent.META_DOWN_MASK, VIEW_VERTICAL_TRANS_KEYS_META,
            this.getActionAttributes(DEVICE_KEYBOARD, VIEW_VERTICAL_TRANS_KEYS));
        this.addAction(DEVICE_KEYBOARD, InputEvent.CTRL_DOWN_MASK | InputEvent.ALT_DOWN_MASK,
