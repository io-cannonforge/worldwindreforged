...
public interface SymbologyConstants
{
    ...
    final List<String> AUXILIARY_EQUIPMENT_ALL = List.of(
    ...
    final List<String> BATTLE_DIMENSION_ALL = List.of(
    ...
    final List<String> BATTLE_DIMENSION_ALL_INTELLIGENCE = List.of(
        BATTLE_DIMENSION_UNKNOWN,
        BATTLE_DIMENSION_SPACE,
        BATTLE_DIMENSION_AIR,
        BATTLE_DIMENSION_GROUND,
    ...
    final List<String> CATEGORY_ALL = List.of(
    ...
    final List<String> CATEGORY_ALL_TACTICAL_GRAPHICS = List.of(
        CATEGORY_TASKS,
        CATEGORY_COMMAND_CONTROL_GENERAL_MANEUVER,
        CATEGORY_MOBILITY_SURVIVABILITY,
        CATEGORY_FIRE_SUPPORT,
    ...
    final List<String> CATEGORY_ALL_STABILITY_OPERATIONS = List.of(
        CATEGORY_VIOLENT_ACTIVITIES,
        CATEGORY_LOCATIONS,
        CATEGORY_OPERATIONS,
        CATEGORY_ITEMS,
    ...
    final List<String> CATEGORY_ALL_EMERGENCY_MANAGEMENT = List.of(
        CATEGORY_INCIDENT,
        CATEGORY_NATURAL_EVENTS,
        CATEGORY_OPERATIONS,
        CATEGORY_INFRASTRUCTURE
    ...
    final List<String> CATEGORY_ALL_METOC = List.of(
        CATEGORY_ATMOSPHERIC,
        CATEGORY_OCEANIC,
        CATEGORY_SPACE
    );
    ...
    final List<String> ECHELON_ALL = List.of(
        ECHELON_TEAM_CREW,
        ECHELON_SQUAD,
        ECHELON_SECTION,
    ...
    final List<String> GRAPHIC_TYPE_ALL = List.of(
        GRAPHIC_TYPE_POINT,
        GRAPHIC_TYPE_LINE,
        GRAPHIC_TYPE_AREA
    );
    ...
    final List<String> INSTALLATION_ALL = List.of(
        INSTALLATION_NORMAL,
    ...
    final List<String> MOBILITY_ALL = List.of(
        MOBILITY_WHEELED,
    ...
    final List<String> MODIFIER_CODE_ALL_UEI = List.of(
     ...
     * feint/dummy.
     */
    final List<String> MODIFIER_CODE_ALL_FEINT_DUMMY = List.of(
        MODIFIER_CODE_FEINT_DUMMY_HEADQUARTERS,
        MODIFIER_CODE_FEINT_DUMMY_TASK_FORCE_HEADQUARTERS,
        MODIFIER_CODE_FEINT_DUMMY,
        MODIFIER_CODE_FEINT_DUMMY_TASK_FORCE
     ...
     * headquarters.
     */
    final List<String> MODIFIER_CODE_ALL_HEADQUARTERS = List.of(
        MODIFIER_CODE_HEADQUARTERS,
        MODIFIER_CODE_TASK_FORCE_HEADQUARTERS,
        MODIFIER_CODE_FEINT_DUMMY_HEADQUARTERS,
        MODIFIER_CODE_FEINT_DUMMY_TASK_FORCE_HEADQUARTERS
     ...
     * force.
     */
    final List<String> MODIFIER_CODE_ALL_TASK_FORCE = List.of(
        MODIFIER_CODE_TASK_FORCE_HEADQUARTERS,
        MODIFIER_CODE_FEINT_DUMMY_TASK_FORCE_HEADQUARTERS,
        MODIFIER_CODE_TASK_FORCE,
        MODIFIER_CODE_FEINT_DUMMY_TASK_FORCE
    ...
    final List<String> OPERATIONAL_CONDITION_ALL = List.of(
    ...
    final List<String> OPERATIONAL_CONDITION_ALTERNATE_ALL = List.of(
    ...
    final List<String> ORDER_OF_BATTLE_ALL = List.of(
        ORDER_OF_BATTLE_AIR,
     ...
     */
    final List<String> ORDER_OF_BATTLE_ALL_UEI_SIGINT_SO_EM = List.of(
        ORDER_OF_BATTLE_AIR,
        ORDER_OF_BATTLE_ELECTRONIC,
        ORDER_OF_BATTLE_CIVILIAN,
        ORDER_OF_BATTLE_GROUND,
    ...
    final List<String> ORDER_OF_BATTLE_ALL_TACTICAL_GRAPHICS = List.of(
        ORDER_OF_BATTLE_CONTROL_MARKINGS
    );
    ...
    final List<String> SCHEME_ALL = List.of(
        SCHEME_WARFIGHTING,
    ...
    final List<String> STANDARD_IDENTITY_ALL = List.of(
    ...
    final List<String> STATIC_DYNAMIC_ALL = List.of(
        STATIC,
        DYNAMIC
    );
    ...
    final List<String> STATUS_ALL = List.of(
     ...
     */
    final List<String> STATUS_ALL_UEI_SIGINT_SO_EM = List.of(
        STATUS_ANTICIPATED,
        STATUS_PRESENT,
        STATUS_FULLY_CAPABLE,
        STATUS_DAMAGED,
     ...
     */
    final List<String> STATUS_ALL_TACTICAL_GRAPHICS_METOC = List.of(
        STATUS_ANTICIPATED,
        STATUS_SUSPECTED,
        STATUS_PRESENT,
        STATUS_KNOWN
