...
public class SectorRangeFan extends AbstractMilStd2525TacticalGraphic implements PreRenderable
{
    ...
    public void setModifier(String modifier, Object value)
    {
        if (SymbologyConstants.DISTANCE.equals(modifier))
        {
            if (value instanceof Iterable)
            {
                ...
                this.setRadii((Iterable<Double>) value);
            }
    ...
    protected void createShapes(DrawContext dc)
    {
        ...
        var radii = this.getRadii().iterator();
        var azimuths = this.getAzimuths().iterator();
    ...
    protected void createLabels()
    {
        ...
        var altitudes = this.getAltitudes().iterator();
        var azimuths = this.getAzimuths().iterator();
    ...
    protected void determineLabelPositions(DrawContext dc)
    {
        ...
        var labelIterator = this.labels.iterator();
        var radii = this.getRadii().iterator();
        var azimuths = this.getAzimuths().iterator();
