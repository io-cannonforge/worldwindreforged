...
public class BasicQuadTree<T> extends BitSetQuadTreeFilter implements Iterable<T>
{
    ...
    protected HashMap<String, T> nameMap = new HashMap<>(); // maps names to items
...
//        final BasicQuadTree<String> tree = new BasicQuadTree<>(treeDepth, Sector.FULL_SPHERE, map);
//
...
//        tree.add(ll.toString(), ll.asDegreesArray());
//
//        Set<String> items = tree.getItemsInRegion(Sector.fromDegrees(0, 45, 0, 55), new HashSet<>());
//
