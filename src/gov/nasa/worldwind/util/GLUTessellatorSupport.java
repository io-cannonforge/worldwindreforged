...
public class GLUTessellatorSupport
{
    ...
    public static String convertGLUTessErrorToString(int errno)
    {
        return switch (errno)
        {
            case GLU.GLU_TESS_MISSING_BEGIN_POLYGON -> "missing begin polygon";
            case GLU.GLU_TESS_MISSING_END_POLYGON -> "missing end polygon";
            case GLU.GLU_TESS_MISSING_BEGIN_CONTOUR -> "missing begin contour";
            case GLU.GLU_TESS_MISSING_END_CONTOUR -> "missing end contour";
            case GLU.GLU_TESS_COORD_TOO_LARGE -> "coordinate too large";
            case GLU.GLU_TESS_NEED_COMBINE_CALLBACK -> "need combine callback";
            default -> "unknown";
        };
    }
