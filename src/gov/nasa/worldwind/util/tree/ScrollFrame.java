...
public class ScrollFrame extends DragControl implements PreRenderable, Renderable
{
    ...
    protected List<ContentTile> tiles = new ArrayList<>();
    /**
     ...
     * the content.
     */
    protected Map<ContentTile, TextureTile> textureTileMap = new HashMap<>();
    /** List to manage sub-tiles of the rendering texture. */
    protected List<TextureTile> textureTiles = new ArrayList<>();
    ...
    protected boolean mustUpdateTiles(DrawContext dc)
    {
        ...
        if ((dc.getTextureCache().getTexture(this.textureCacheKey) == null) || tiles.isEmpty())
            return true;
