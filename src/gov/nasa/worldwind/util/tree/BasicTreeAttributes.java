...
public class BasicTreeAttributes implements TreeAttributes
{
    ...
    public boolean equals(Object o)
    {
        ...
        if ((this.rootVisible != that.rootVisible) || (this.textColor != null ? !this.textColor.equals(that.textColor) : that.textColor != null) || (this.font != null ? !this.font.equals(that.font) : that.font != null)
				|| (this.descriptionFont != null ? !this.descriptionFont.equals(that.descriptionFont)
