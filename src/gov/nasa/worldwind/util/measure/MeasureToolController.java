        ...
        implements MouseListener, MouseMotionListener, SelectListener, PositionListener, RenderingListener
{
	...
	public void mouseDragged(MouseEvent mouseEvent)
    {
        ...
        if (this.isActive() && this.isArmed() && (mouseEvent.getModifiersEx() & InputEvent.BUTTON1_DOWN_MASK) != 0)
        {
    ...
    {
        if ((this.movingTarget != null) || (!event.getEventAction().equals(SelectEvent.DRAG) && !event.getEventAction().equals(SelectEvent.DRAG_END)))
            return;
