...
public class OrbitViewInputHandler extends BasicViewInputHandler
{
    ...
    protected void initializeInputHandlers()
    {
        ...
        {
            new ViewInputAttributes.ActionAttributes.MouseAction(InputEvent.BUTTON1_DOWN_MASK)
        };
        ...
        ViewInputAttributes.ActionAttributes actionAttribs)
    {
        ...
        View view = this.getView();
        if ((view == null) || (latitudeChange.equals(Angle.ZERO) && longitudeChange.equals(Angle.ZERO)))
        {
            return;
        }
    ...
    {
        View view = this.getView();
        if ((view == null) || (forwardChange.equals(Angle.ZERO) && sideChange.equals(Angle.ZERO)))
        {
            return;
        }
    ...
    {
        View view = this.getView();
        if ((view == null) || Angle.ZERO.equals(view.getRoll())) // Don't need to reset if roll is already zero
        {
            return;
        }
    ...
    {
        View view = this.getView();
        if ((view == null) || (translateChange == 0))
        {
            return;
        }
        if (view instanceof BasicOrbitView)
