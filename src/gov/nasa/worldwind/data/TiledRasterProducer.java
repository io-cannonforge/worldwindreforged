...
public abstract class TiledRasterProducer extends AbstractDataStoreProducer
{
    ...
    private java.util.List<DataRaster> dataRasterList = new java.util.ArrayList<>();
    // Data raster caching.
	...
	public String getDataSourceDescription()
    {
        ...
        java.util.Set<String> suffixSet = new java.util.TreeSet<>();
        java.util.Set<String> descriptionSet = new java.util.TreeSet<>();
    ...
    protected int extractMaxLevelLimit(AVList params, int maxNumOfLevels)
    {
        if (null != params && params.hasKey(AVKey.TILED_RASTER_PRODUCER_LIMIT_MAX_LEVEL))
        {
            ...
            else if (o instanceof String strLimit)
            {
    ...
    protected void appendProperties(Element context, AVList properties)
    {
        ...
        // add properties
        for (var entry : properties.getEntries())
        {
            sb.setLength(0);
