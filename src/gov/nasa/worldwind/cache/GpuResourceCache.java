...
public interface GpuResourceCache
{
    ...
    /**
     * Identifies resources as raw GL texture IDs (int[]). Used when a texture is created via glGenTextures rather than
     * as a JOGL Texture object. The cache will call glDeleteTextures on eviction.
     * Added by seaglassfoundry.com to support heightmap textures in RectangularTessellator.
     */
    public static final String TEXTURE_IDS = "gov.nasa.worldwind.cache.GpuResourceCache.TextureIds";

    /**
     * Identifies resources as Vertex Array Object IDs (int[]). The cache will call glDeleteVertexArrays on eviction.
     * Added by seaglassfoundry.com for terrain tile VAO caching.
     */
    public static final String VAO_IDS = "gov.nasa.worldwind.cache.GpuResourceCache.VaoIds";
