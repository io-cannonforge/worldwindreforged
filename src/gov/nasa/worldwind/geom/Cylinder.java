...
public class Cylinder implements Extent, Renderable
{
	...
	public Intersection[] intersect(Line line)
    {
        ...
        if (!intcyl(line.getOrigin(), line.getDirection(), this.bottomCenter, this.axisUnitDirection,
            this.cylinderRadius, tVals) || !clipcyl(line.getOrigin(), line.getDirection(), this.bottomCenter, this.topCenter,
    ...
    public boolean equals(Object o)
    {
        ...
        if ((Double.compare(cylinder.cylinderHeight, cylinderHeight) != 0) || (Double.compare(cylinder.cylinderRadius, cylinderRadius) != 0) || (axisUnitDirection != null ? !axisUnitDirection.equals(cylinder.axisUnitDirection)
            : cylinder.axisUnitDirection != null) || (bottomCenter != null ? !bottomCenter.equals(cylinder.bottomCenter) : cylinder.bottomCenter != null))
            return false;
