...
public class ExtrudedPolygon extends AbstractShape
{
    ...
    protected static class ShapeData extends AbstractShapeData implements Iterable<ExtrudedBoundaryInfo>
    {
        ...
        protected List<ExtrudedBoundaryInfo> boundaries = new ArrayList<>();
    ...
    protected static HashMap<Integer, IntBuffer> capEdgeIndexBuffers = new HashMap<>();
    protected static HashMap<Integer, IntBuffer> sideFillIndexBuffers = new HashMap<>();
    protected static HashMap<Integer, IntBuffer> sideEdgeIndexBuffers = new HashMap<>();
