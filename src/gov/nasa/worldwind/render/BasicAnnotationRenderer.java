...
public class BasicAnnotationRenderer implements AnnotationRenderer
{
    ...
    protected HashSet<Annotation> currentPickAnnotations = new HashSet<>();
    protected HashSet<Annotation> currentDrawAnnotations = new HashSet<>();
...
//
//    //-- Collision avoidance ---------------------------------------------------
//    ArrayList<Rectangle> usedRectangles = new ArrayList<>();
