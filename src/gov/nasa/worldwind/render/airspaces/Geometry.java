...
public class Geometry extends AVListImpl implements Cacheable
{
    public static class CacheKey
    {
		...
		public boolean equals(Object o)
        {
            ...
            if ((this.globeStateKey != null ? !this.globeStateKey.equals(that.globeStateKey) : that.globeStateKey != null) || (this.cls != null ? !this.cls.equals(that.cls) : that.cls != null) || (this.key != null ? !this.key.equals(that.key) : that.key != null) || !Arrays.deepEquals(this.params, that.params))
                return false;
    ...
    private long sizeOf(int glType)
    {
        ...
        {
            case GL.GL_BYTE -> 1L;
            case GL.GL_SHORT, GL.GL_UNSIGNED_SHORT -> 2L;
            case GL2ES2.GL_INT, GL.GL_UNSIGNED_INT, GL.GL_FLOAT -> 4L;
            case GL2GL3.GL_DOUBLE -> 8L;
            default -> 0L;
        };
    }
