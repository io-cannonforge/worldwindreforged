...
public abstract class AbstractAirspaceEditor extends AbstractLayer implements AirspaceEditor
{
    ...
    {
        // Include this test to ensure any derived implementation performs it.
        if (this.getAirspace() == null || this.getAirspace() != airspace || wwd == null || mousePoint == null)
        {
            return null;
        }
    ...
    {
        // Include this test to ensure any derived implementation performs it.
        if ((this.getAirspace() == null) || wwd == null || controlPoint == null)
        {
            return;
        }
    ...
    {
        // Include this test to ensure any derived implementation performs it.
        if ((this.getAirspace() == null) || this != controlPoint.getEditor() || this.getAirspace() != controlPoint.getAirspace())
        {
            return;
        }
