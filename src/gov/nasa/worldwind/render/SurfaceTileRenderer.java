...
public abstract class SurfaceTileRenderer implements Disposable
{
    ...
    protected void initAlphaTexture(DrawContext dc, int size)
    {
        ...
        this.alphaTexture.setTexParameteri(gl, GL.GL_TEXTURE_WRAP_S, GL2ES2.GL_CLAMP_TO_BORDER);
        this.alphaTexture.setTexParameteri(gl, GL.GL_TEXTURE_WRAP_T, GL2ES2.GL_CLAMP_TO_BORDER);
