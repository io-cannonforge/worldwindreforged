...
public class BasicSceneController extends AbstractSceneController
{
    ...
    // seaglassfoundry.com: demand-driven pick pass -- skip full pick when no mouse interaction is active,
    // resolving viewport center position via lightweight ray-intersection instead.
    protected void doNormalRepaint(DrawContext dc)
    {
        ...
        {
            this.resolveViewportCenterPosition(dc);
            this.pickTime = 0;
        }
        this.draw(dc);
    }

    // seaglassfoundry.com: demand-driven pick pass for 2D contiguous globe mode
