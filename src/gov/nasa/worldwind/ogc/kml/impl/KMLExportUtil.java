...
public class KMLExportUtil
{
    ...
    {
        return switch (altitudeMode)
        {
            case WorldWind.CLAMP_TO_GROUND -> "clampToGround";
            case WorldWind.RELATIVE_TO_GROUND -> "relativeToGround";
            case WorldWind.ABSOLUTE, WorldWind.CONSTANT -> "absolute";
            default ->
            {
