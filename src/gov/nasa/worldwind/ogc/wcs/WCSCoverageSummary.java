...
public class WCSCoverageSummary extends AbstractXMLEventParser
{
    ...
    protected List<String> abstracts = new ArrayList<>(1);
    protected List<OWSWGS84BoundingBox> boundingBoxes = new ArrayList<>(1);
    protected List<WCSCoverageSummary> coverageSummaries = new ArrayList<>(1);
    protected List<String> supportedCRSs = new ArrayList<>(1);
    protected List<String> supportedFormats = new ArrayList<>(1);
    protected List<String> titles = new ArrayList<>(1);
    ...
    {
        var iter = this.abstracts.iterator();
    ...
    {
        var iter = this.boundingBoxes.iterator();
