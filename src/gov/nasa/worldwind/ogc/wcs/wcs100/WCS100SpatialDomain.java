...
{
    protected List<GMLEnvelope> envelopes = new ArrayList<>(1);
    protected List<GMLRectifiedGrid> rectifiedGrids = new ArrayList<>(1);
    protected List<GMLGrid> grids = new ArrayList<>(1);
