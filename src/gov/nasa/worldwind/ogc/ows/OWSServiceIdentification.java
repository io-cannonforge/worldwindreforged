...
public class OWSServiceIdentification extends AbstractXMLEventParser
{
    ...
    protected List<String> accessConstraints = new ArrayList<>(1);
    protected List<String> profiles = new ArrayList<>(1);
    protected List<String> titles = new ArrayList<>(1);
    protected List<String> serviceTypeVersions = new ArrayList<>(1);
