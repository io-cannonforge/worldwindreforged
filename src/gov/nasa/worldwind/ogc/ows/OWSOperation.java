...
public class OWSOperation extends AbstractXMLEventParser
{
    ...
    protected List<OWSDCP> dcps = new ArrayList<>(2);
    protected List<OWSParameter> parameters = new ArrayList<>(1);
    protected List<OWSConstraint> constraints = new ArrayList<>(1);
